        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              className="px-6 py-3.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-white font-mono text-xs uppercase tracking-wider transition-colors"
            >
      ...
      <section className="py-24 bg-[#090b10] border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            {/* Benchmark 1 */}
            <div className="p-8 rounded-3xl bg-[#0e1118] border border-white/12 space-y-4">
              <span className="text-xs font-mono text-white/40 uppercase tracking-widest block">
                BENCHMARK 01 // FIRST CONTACT LATENCY
              </span>
              <div className="flex items-baseline gap-4">
                <span className="text-4xl sm:text-5xl font-display font-black text-[#d4ff00]">
                  10–30 MIN
                </span>
                <span className="text-sm font-mono text-white/40 line-through">DMS: 6–24 HOURS</span>
              </div>
            ...
            <div className="p-8 rounded-3xl bg-[#0e1118] border border-white/12 space-y-4">
              ...
              <div className="flex items-baseline gap-4">
                <span className="text-4xl sm:text-5xl font-display font-black text-[#00f58c]">
                  &gt;90%
                </span>
                <span className="text-sm font-mono text-white/40 line-through">DMS: &lt;40%</span>
              </div>
              <p className="text-sm text-white/70 leading-relaxed font-normal">
